# Mocktail — Alcohol-Free Cocktail Recipes                                                                                                                 
  ...
  **Last Updated:** April 26, 2026                                                                                                                           
  ...
  - Anonymous app performance metrics (for debugging purposes only)                                                                                          
  ...
  - To securely sync your data across your devices via Apple iCloud.                                                                                         
  ...
  When iCloud sync is enabled, your favorites, notes, and preferences are synchronized across your devices through Apple's iCloud infrastructure. This data  
  ...
  You have full access rights to all data you add to the app. Since data is stored locally on the device and within your iCloud account, you can permanently 
  delete this data from within the app at any time. When you delete the app from your device, all local data is automatically removed.
  ...
  **Mocktail cannot be held responsible in any way for allergic reactions, digestive issues, medication interactions, or any other negative health outcomes  
  ...
  The app does not require an external membership or database account. Users who sign in with their personal Apple iCloud account can seamlessly sync their  
  data across their other Apple devices. Users are strictly responsible for their own Apple device and iCloud account security.
                                                                                                                                                             
  ### 4. Subscriptions and Payments (Mocktail+)                                                                                                              
  ...
  Unauthorized copying of the app's source code, reverse engineering, or exactly duplicating the design to convert it into a commercial asset on different   
  platforms is strictly prohibited. Legal action will be taken upon detection of such intellectual property violations.
